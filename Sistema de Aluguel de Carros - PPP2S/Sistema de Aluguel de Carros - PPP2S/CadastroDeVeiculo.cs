...
namespace Sistema_de_Aluguel_de_Carros___PPP2S
{
    ...
    public partial class CadastroDeVeiculo : Form
    {
        ...
        {
            if (boxModelo.Text != "" && boxMarca.Text != "" && tBoxAno.MaskCompleted && boxCategoria.Text != "" && boxCombustivel.Text != "" && tBoxConcessionaria.Text != "" && tBoxValor.Text != "")
            {
                ...
                if (checkPlaca.Checked && tBoxPlacaNov.MaskCompleted)
                {
                    ...
                    {
                        Cadastrar(boxMarca.Text, boxModelo.Text, tBoxAno.Text, boxCategoria.Text, boxCor.Text, tBoxPlacaNov.Text, boxCombustivel.Text, tBoxConcessionaria.Text, tBoxValor.Text);
                ...
                else if (!checkPlaca.Checked && tBoxPlacaAnt.MaskCompleted)
                {
                    ...
                    {
                        Cadastrar(boxMarca.Text, boxModelo.Text, tBoxAno.Text, boxCategoria.Text, boxCor.Text, tBoxPlacaAnt.Text, boxCombustivel.Text, tBoxConcessionaria.Text, tBoxValor.Text);
                    }
                    else { MessageBox.Show("placa ja existente no banco de dados"); }
